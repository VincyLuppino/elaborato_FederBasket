...
<body>
    ...
    <header id="header" class="fixed-top">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo mr-auto"><a href="index.php"><img src="assets/img/logoFIP.jpg"></a></h1>
    ...
    <section id="hero">
        <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <!-- Slide 1 -->
                <div class="carousel-item active" style="background-image: url(assets/img/logo.png)">
                    <div class="carousel-container">
                        <div class="container">
                            <h2 class="animate__animated animate__fadeInDown" style="color:white;">Benvenuto in <span>FIP</span></h2>
                            <p class="animate__animated animate__fadeInUp" style="color:white;">Federazione italiana pallacanestro</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="info-box">
                                    ...
                                    <p>Via Santa Caterina da Siena, 3, 22066 Mariano Comense CO</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box mt-4">
                                    ...
                                    <h3>Email</h3>
                                    <p>info@progetto.com<br>contact@progetto.com</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="info-box mt-4">
