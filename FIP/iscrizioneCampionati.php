    ...
    <div class="row" style="margin-top: 100px; font-size:20px;">
        <div class="col-md-6 col-sm-12 col-lg-6 col-md-offset-3">
            <div class="panel panel-primary">
                <div class="panel-heading">Iscrizione campionati
                </div>
                <div class="panel-body">
                    <form name="myform">
                        ...
                        <br>
                        <button id="submit" type="submit" value="submit" class="btn btn-primary center" style="font-size: 14px;">Iscriviti</button>
