                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="success.php" method="">
                                <div class="form-group row">
                                    <label for="full_name" class="col-md-4 col-form-label text-md-right">Nome e cognome</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" id="address" class="form-control" placeholder="Via Prova 5, Città">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label for="address" class="col-md-4 col-form-label text-md-right">Data di nascita</label>
                                    <div class="col-md-6">
                                        <input type="date" id="dataDiNascita" class="form-control">
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-md-4 col-form-label text-md-right">Genere</label>
                                    <div class="col-sm-6">
                                        <div class="row">
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                <label class="form-control">
                                                    <input type="radio" id="maleRadio" name="gender" value="Male">Maschio
                                                </label>
                                            </div>
                                        </div>
                                    </div>
