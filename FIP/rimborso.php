...
<body style="background-image: url('assets/img/basketBackground.jpg')">
    ...
    <div class="container d-flex justify-content-center">
        <div class="card p-3">
            <div class="d-flex flex-row justify-content-between text-align-center"> <img src="assets/img/faviconFIP.jpg"> <img src="https://imgur.com/vvK2ARv.png"> <i class="fas fa-ellipsis-v"></i> </div>
            <p class="text-dark">Riepilogo movimenti contabili</p>
            <div class="card-bottom pt-3 px-3 mb-2">
                <div class="d-flex flex-row justify-content-between text-align-center">
                    <div class="d-flex flex-column"><span>SALDO</span>
                        <p>&euro; <span class="text-white">88,98</span></p>
                    </div>
                </div>
            </div>
        </div>
